...
@JvmOverloads constructor(activity: Activity, level: Int, flags: Int,
    ...
    /**
     * Show the system UI. What this means depends onLoaded the mode this [android.example.android.systemuivis.SystemUiHelper] was
     * instantiated with.
     *
     *
    ...
    /**
     * Hide the system UI. What this means depends onLoaded the mode this [android.example.android.systemuivis.SystemUiHelper] was
     * instantiated with.
     *
     *
     * Any currently queued delayed hide requests will be removed.
    ...
    companion object {
         ...
         *
         *
         * This flag isn't used onLoaded newer devices because the [action
